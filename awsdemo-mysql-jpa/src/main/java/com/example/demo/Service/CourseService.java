...
public class CourseService {
    ...
    public void update(Course course) {
        repo.updateByCourseID(course.getCourseName(),course.getFkDocumentLibID(),course.getStatus(),course.getStartDate(),course.getEndDate(),course.getDescription(),course.getPrice(),course.getLogoPath(),course.getCourseID());
    }
